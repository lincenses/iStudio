...
namespace StudioDemo
{
    public partial class FormExcelDemo : Form
    {
        ...
        private void ToolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            //    //DataTable dataTable = Studio.Extension.NPOIMethod.GetDataTableFromExcelFile(openDialog.FileName, "Sheet1", 0, 0);
            //    DataTable dataTable = Studio.Extension.NPOIMethod.GetDataTableFromExcelFile(openDialog.FileName, "Sheet1", 1, 0, true, "№", "工号", "姓名", "生日", "年龄", "已婚", "备注");
